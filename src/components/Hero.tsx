  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-300 to-gray-600">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-serif text-white mb-4 sm:mb-6 leading-tight lg:whitespace-nowrap">
          Online management leadership program
        </h1>
        
        <div className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-serif text-white mb-4 sm:mb-6 leading-tight">
          Achieve{' '}
        ...
        <button className="bg-black border-2 border-yellow-400 text-white font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-lg text-base sm:text-lg transition-all duration-300 hover:bg-gray-900 hover:border-yellow-300">
          Enroll Now
        </button>
      </div>
    </section>
